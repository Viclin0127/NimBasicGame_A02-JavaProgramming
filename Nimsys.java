/**
 * COMP90041 Programming and Software Developing Assignment 2:
...
public class Nimsys {
    ...
    public NimPlayer[] players = new NimPlayer[100];
    ...
    private void addPlayer(String userName, String familyName, String givenName) {
        ...
        players[playerNo] = new NimPlayer(userName, familyName, givenName);
        playerNo++;
        commandFormat();
    }
